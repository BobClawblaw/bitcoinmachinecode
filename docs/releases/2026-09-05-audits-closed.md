...
One thing is **not** closed, and it is not a defect; one more is **closed by
decision** rather than by a change:
...
- **Hand-written consensus assembly** (08-30 Finding 3) is a standing property
  ...
  gate, not by a patch.
- **`LimitCORE`/systemd hardening** (08-29 #11 / 09-02 N5 / 09-03 §3) — **closed by operator decision, 2026-09-05: the
