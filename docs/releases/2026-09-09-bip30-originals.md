...
- `test_coinstats_hist` pins the heights both ways and off-mainnet; **watched to fail** on the old heights (2). The proof at scale is the rebuilt base agreeing with Core: GATE_LINE
