...
extern unsigned long long consdbg, consdbg2, consdbg3;
...
int main(void){
    ...
    printf("ret=%d consdbg=0x%llx txid_tmp=0x%llx prebl_x0=0x%llx\n", r, consdbg, consdbg2, consdbg3);
    printf("scratch0=%02x%02x%02x%02x\n",scratch[0],scratch[1],scratch[2],scratch[3]);
    return 0;
}
