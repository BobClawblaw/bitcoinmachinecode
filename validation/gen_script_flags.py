...
print("heights: BIP66(DERSIG)=%d BIP65(CLTV)=%d CSV=%d Segwit(WITNESS+NULLDUMMY)=%d"
      % (BIP66, BIP65, CSV, SEGWIT))
...
print("self-check ok: %d heights + %d exception hashes re-parse correctly" % (4, len(exc_lines)))
