/* tests/musig2_vectors.h -- BIP327 MuSig2 test vectors, verbatim from libsecp256k1
 * (src/modules/musig/vectors.h, MIT licence), which itself is generated from the
 * BIP's reference vectors. Consumed by tests/test_musig2.c. */
/**
