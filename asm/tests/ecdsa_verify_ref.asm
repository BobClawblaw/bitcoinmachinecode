; ============================================================================
; tests/ecdsa_verify_ref.asm -- FROZEN pre-PERF_SCOPE-4.2 copy of
;   secp256k1_ecdsa.asm (main @ 0fc5d06), symbol renamed ecdsa_verify_ref.
;   Test-only differential reference: affine x via fe_inv + Fermat sc_inv.
;   DO NOT EDIT -- it exists so tests/test_ecdsa_inverse can prove the new
;   inversion-free / variable-time-inverse verify gives byte-identical
;   verdicts. Not linked into any daemon or tool.
; ============================================================================
; ============================================================================
