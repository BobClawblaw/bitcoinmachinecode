...
int main(void){
    ...
    long r0 = utxo_put(u, txid, 0, 100, 0, 0, script, 4);
    long r4 = utxo_put(u, txid, 4, 400, 0, 0, script, 4);
    long r8 = utxo_put(u, txid, 8, 800, 0, 0, script, 4);
    ...
    long g4 = utxo_get(u, txid, 4, &val, &h_unused, &cb_unused, &sp, &sl);
    long g8 = utxo_get(u, txid, 8, &val, &h_unused, &cb_unused, &sp, &sl);
