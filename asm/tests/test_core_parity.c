...
int main(void){
    ...
    ck("rpcworkqueue defaults to Core's 64",           g_cfg.rpcworkqueue == 64);
    ck("rpcservertimeout defaults to Core's 30 s",     g_cfg.rpcservertimeout == 30);
    ...
    { extern int nodecfg_unimplemented(const char*);
      ...
      ck("walletnotify is NOT flagged -- implemented 2026-09-01",
         nodecfg_unimplemented("walletnotify") == 0); }
