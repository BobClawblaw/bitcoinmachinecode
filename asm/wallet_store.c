 ...
 * versioned file of our own format. Everything else (the 64-byte seed and all
 * BIP44 addresses/keys) is deterministically derived from the mnemonic at load
 * time via the verified wallet_core API.
 *
